...
function App() {
  ...
  const loadBefore = () => {
    setBeforeImage({
      src: 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200"><rect width="300" height="200" fill="%23ff0000"/><text x="150" y="100" text-anchor="middle" fill="white">BEFORE IMAGE</text></svg>',
  ...
  const loadAfter = () => {
    setAfterImage({
      src: 'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="200"><rect width="300" height="200" fill="%2300ff00"/><text x="150" y="100" text-anchor="middle" fill="white">AFTER IMAGE</text></svg>',
      name: 'test-after.svg',
      loaded: true,
      type: 'after'
    })
  ...
  const getStatusText = () => {
    ...
    if (!hasImages) {
      ...
      return 'STAGE • BEFORE: IMG loaded • AFTER: IMG loaded'
    }
    return 'STAGE • EMPTY'
  }
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          {beforeImage ? (
            <div>
              ...
              <div style={{ fontSize: '12px', marginTop: '5px' }}>{beforeImage.name}</div>
            </div>
          ) : (
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          {afterImage ? (
            <div>
              ...
              <div style={{ fontSize: '12px', marginTop: '5px' }}>{afterImage.name}</div>
            </div>
          ) : (
            <div style={{ width: '150px', height: '100px', backgroundColor: '#f0f0f0', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '2px dashed #ccc' }}>
              No Image
